...
>
  <p
    ...
    "
  >
    At <span className="font-semibold text-orange-300">
      ANAND IMPORTS & EXPORTS
    </span>, quality is not a promise it is a standard. Every product we handle is
    carefully selected and managed to meet international benchmarks, ensuring
    consistency, safety, and customer satisfaction. Our strong global network
    enables us to serve diverse industries while maintaining competitive pricing
    and timely delivery.
  </p>
</motion.div>
   ...
   {/* Our Commitment - Soft Theme */}
<section
  ref={ref3}
  className="pt-6 sm:pt-8 md:pt-12 pb-6 sm:pb-8 md:pb-12 bg-slate-50"
>
    ...
    >
      <motion.div variants={itemVariants}>
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <div className="w-20 sm:w-24 h-[3px] bg-gradient-to-r from-blue-400 to-orange-400 mx-auto rounded-full" />
        </div>
        ...
        <p className="
          ...
          text-left
        ">
          Anand Imports & Exports is a dynamic global trading enterprise committed
          to connecting national and international markets. We specialize in the
          seamless movement of high-quality goods across borders, ensuring
          reliability, transparency, and value in every transaction. Through
          strong sourcing networks, strategic partnerships, and an unwavering
          commitment to excellence, Anand Group stands as a trusted trading
