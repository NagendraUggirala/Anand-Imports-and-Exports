          ...
          >
            ...
            >
              ...
              <p className="text-base md:text-lg text-blue-100 mb-4 leading-relaxed">
                Ready to grow your global business? Our team is here to support
                you at every step with trusted import & export services
              </p>
            </motion.div>
                ...
                <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200 w-full flex flex-col">
                  <div className="flex-1">
                    ...
                    <p className="text-slate-600 mb-6 text-sm leading-relaxed">
                      Have questions about global trade or need guidance? We're
                      here to help you grow your business across international
                      markets.
                    </p>
                    ...
                    <div className="flex flex-col md:flex-row md:items-start justify-between mb-6">
                      <div className="mb-4 md:mb-0">
                        ...
                        <p className="text-slate-600 text-sm md:text-base max-w-2xl">
                          Fill out the form below with your trade requirements,
                          and we’ll respond within 24 hours with customized
                    ...
                    >
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          onChange={handleChange}
                          placeholder="Tell us about your specific trade requirements, preferred markets, product specifications, and any other details that will help us deliver the right global trade solution......"
